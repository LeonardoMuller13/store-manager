<template>
	<Modal ref="Modal">
		<template v-slot:header>
			<span class="modal-title">Despesas gerais</span>
		</template>
		<template v-slot:body>
			...
			<ModalNewExpense ref="ModalNewExpense" />
		</template>
...
<script>
	...
	export default {
		name: "ModalExpenses",
		components: {Modal, Button, Datepicker, Select, ModalNewExpense},
		...
		methods:{
			...
			loadData(){
				...
				BillingServices.loadExpenses(this.date)
			...
			newExpense(){
				var self = this;
				this.$refs.ModalNewExpense.showModal()
				.then(function(){
					self.loadData();
					self._resolve();
				})
			...
			deleteExpense(expense){
				...
				.then(function(){
					BillingServices.deleteExpense(expense.expense_id)
					.then(function(){
						self.loadData();
						self._resolve();
					})
